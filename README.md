...
2. create an environment using the file in the folder [installation](https://github.com/iit-DLSLab/Quadruped-PyMPC/tree/main/installation) choosing between nvidia - integrated_gpu, and between with and without ros (to run the simulation, you don't need ros!):
