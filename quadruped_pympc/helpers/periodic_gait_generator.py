...
class PeriodicGaitGenerator:
    ...
    def update_start_and_stop(self, feet_pos, hip_pos, hip_offset, 
        ...
        feet_to_hip_distance_h_FL = np.sqrt(np.square(feet_pos_h.FL[0] - hip_pos_h.FL[0]) + np.square(feet_pos_h.FL[1] - hip_pos_h.FL[1]))
        feet_to_hip_distance_h_FR = np.sqrt(np.square(feet_pos_h.FR[0] - hip_pos_h.FR[0]) + np.square(feet_pos_h.FR[1] - hip_pos_h.FR[1]))
        feet_to_hip_distance_h_RL = np.sqrt(np.square(feet_pos_h.RL[0] - hip_pos_h.RL[0]) + np.square(feet_pos_h.RL[1] - hip_pos_h.RL[1]))
        feet_to_hip_distance_h_RR = np.sqrt(np.square(feet_pos_h.RR[0] - hip_pos_h.RR[0]) + np.square(feet_pos_h.RR[1] - hip_pos_h.RR[1]))
        feet_to_hip_distance_h = np.mean([feet_to_hip_distance_h_FL, feet_to_hip_distance_h_FR, feet_to_hip_distance_h_RL, feet_to_hip_distance_h_RR]) 
