    ...
    def create_ocp_solver_description(self, acados_model) -> AcadosOcp:
        ...
        ocp.parameter_values = np.concatenate(
            (
                ...
                init_end_effector_position,
                init_end_effector_jacobian_inv,
                init_end_effector_jacobian_transpose_inv,
                init_end_effector_gain,
            )
        )
    ...
    def create_stability_constraints(self) -> None:
        ...
        if self.use_static_stability:
            ...
            zmp_x = (
                ...
                - base_w[2] * self.centroidal_model.mass * linear_com_acc[0] * 0
            )
            zmp_x = (
                zmp_x
            ...
            zmp_y = (
                ...
                - base_w[2] * self.centroidal_model.mass * linear_com_acc[1] * 0
            )
            zmp_y = (
                zmp_y
    ...
    def compute_control(
        ...
        for j in range(self.horizon):
            ...
            if number_of_legs_in_stance == 0:
                ...
                reference_force_stance_legs = (self.centroidal_model.mass * self.centroidal_model.gravity_constant) / number_of_legs_in_stance
        ...
        for j in range(self.horizon):
            ...
            param = np.array(
                [
                    ...
                    end_effector_jacobian_inv[0],
                    end_effector_jacobian_inv[1],
                    end_effector_jacobian_inv[2],
                    end_effector_jacobian_inv[3],
                    end_effector_jacobian_inv[4],
                    end_effector_jacobian_inv[5],
                    end_effector_jacobian_inv[6],
                    end_effector_jacobian_inv[7],
                    end_effector_jacobian_inv[8],
                    end_effector_jacobian_transpose_inv[0],
                    end_effector_jacobian_transpose_inv[1],
                    end_effector_jacobian_transpose_inv[2],
                    end_effector_jacobian_transpose_inv[3],
                    end_effector_jacobian_transpose_inv[4],
                    end_effector_jacobian_transpose_inv[5],
                    end_effector_jacobian_transpose_inv[6],
                    end_effector_jacobian_transpose_inv[7],
                    end_effector_jacobian_transpose_inv[8],
                    end_effector_gain[0],
                    end_effector_gain[1],
                    end_effector_gain[2],
                ]
