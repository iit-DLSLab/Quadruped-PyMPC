...
class Acados_NMPC_KinoDynamic:
    ...
    def create_ocp_solver_description(self, acados_model) -> AcadosOcp:
        ...
        ocp.model.cost_y_expr = cs.vertcat(
            ocp.model.x[0:12],
            self.centroidal_model.foot_position_fl,
            self.centroidal_model.foot_position_fr,
            self.centroidal_model.foot_position_rl,
            self.centroidal_model.foot_position_rr,
            ocp.model.x[24:],
            ocp.model.u,
            ocp.model.x[12:24],
        )
        ...
        expr_h_foot_vel, self.constr_uh_foot_vel, self.constr_lh_foot_vel = self.create_foot_vel_constraints()
    ...
    def create_foot_vel_constraints(self) -> None:
        ...
        qvel = cs.vertcat(
            com_velocity, com_angular_velocity, qvel_joints_FL, qvel_joints_FR, qvel_joints_RL, qvel_joints_RR
        )
    ...
    def perform_scaling(self, state, reference, constraint=None):
        ...
        reference["ref_foot_swing_FL"] = reference["ref_foot_swing_FL"] - state["position"]
    ...
    def compute_control(
        ...
        for j in range(self.horizon):
            ...
            yref[12:15] = reference["ref_foot_swing_FL"][j]
            yref[15:18] = reference["ref_foot_swing_FR"][j]
            yref[18:21] = reference["ref_foot_swing_RL"][j]
            yref[21:24] = reference["ref_foot_swing_RR"][j]
        ...
        return (
            optimal_GRF,
            optimal_foothold,
            optimal_joint_positions,
            optimal_joint_velocities,
            optimal_joint_acceleration,
            optimal_next_state,
            status,
        )
