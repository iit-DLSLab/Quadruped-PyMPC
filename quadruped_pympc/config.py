...
elif (robot == 'aliengo_arm'):
    mass = 24.637
    inertia = np.array([[0.2310941359705289, -0.0014987128245817424, -0.021400468992761768],
                        [-0.0014987128245817424, 1.4485084687476608, 0.0004641447134275615],
                        [-0.021400468992761768, 0.0004641447134275615, 1.503217877350808]])
    robot_leg_joints = dict(FL=['first/FL_hip_joint', 'first/FL_thigh_joint', 'first/FL_calf_joint',],  # TODO: Make configs per robot.
                        FR=['first/FR_hip_joint', 'first/FR_thigh_joint', 'first/FR_calf_joint',],
                        RL=['first/RL_hip_joint', 'first/RL_thigh_joint', 'first/RL_calf_joint',],
                        RR=['first/RR_hip_joint', 'first/RR_thigh_joint', 'first/RR_calf_joint',])
    robot_leg_joints_2 = dict(FL=['second/FL_hip_joint', 'second/FL_thigh_joint', 'second/FL_calf_joint',],  # TODO: Make configs per robot.
                              FR=['second/FR_hip_joint', 'second/FR_thigh_joint', 'second/FR_calf_joint',],
                              RL=['second/RL_hip_joint', 'second/RL_thigh_joint', 'second/RL_calf_joint',],
                              RR=['second/RR_hip_joint', 'second/RR_thigh_joint', 'second/RR_calf_joint',])
    robot_leg_joints_big = dict(FL1=['first/FL_hip_joint', 'first/FL_thigh_joint', 'first/FL_calf_joint',],  # TODO: Make configs per robot.
                            FR1=['first/FR_hip_joint', 'first/FR_thigh_joint', 'first/FR_calf_joint',],
                            RL1=['first/RL_hip_joint', 'first/RL_thigh_joint', 'first/RL_calf_joint',],
                            RR1=['first/RR_hip_joint', 'first/RR_thigh_joint', 'first/RR_calf_joint',],
                            FL2=['second/FL_hip_joint', 'second/FL_thigh_joint', 'second/FL_calf_joint',],
                            FR2=['second/FR_hip_joint', 'second/FR_thigh_joint', 'second/FR_calf_joint',],
                            RL2=['second/RL_hip_joint', 'second/RL_thigh_joint', 'second/RL_calf_joint',],
                            RR2=['second/RR_hip_joint', 'second/RR_thigh_joint', 'second/RR_calf_joint',],)
    robot_feet_geom_names = dict(FL='first/FL', FR='first/FR', RL='first/RL', RR='first/RR')
    robot_feet_geom_names_2 = dict(FL='second/FL', FR='second/FR', RL='second/RL', RR='second/RR')

    robot_feet_geom_names_big = dict(FL1='first/FL', FR1='first/FR', RL1='first/RL', RR1='first/RR',
                                FL2='second/FL', FR2='second/FR', RL2='second/RL', RR2='second/RR')
    #the keys for the dictionary are the names of the legs, the values are the names of the joints
    keys=['FL1','FR1','RL1','RR1','FL2','FR2','RL2','RR2']
    urdf_filename = "aliengo_double.urdf"
    hip_height = 0.35
...
mpc_params = {
    ...
    'type':                                    'input_rates',  # 'nominal', 'input_rates', 'sampling', 'collaborative'
