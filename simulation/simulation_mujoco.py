...
if __name__ == '__main__':
    ...
    # firest create or select the controller type and the dictionary with the entries needed in this case we use the
    # config file
    ...
    for episode_num in tqdm(range(N_EPISODES), desc="Episodes"):
        ...
        for _ in range(N_STEPS_PER_EPISODE):
            ...
            ref_state, state_current, ref_feet_pos, contact_sequence = controller.update_mpc_reference_and_state(
                nv=nv,
